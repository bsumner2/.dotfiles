" 'flattened_darker.vim' -- Vim color scheme.
" Maintainer:   N/A. Edited 1-off version of Romain Lafourcade's flattened_dark.vim (romainlafourcade@gmail.com)
" Description:  Dark Solarized, without as much green.
...
let colors_name = 'flattened_darker'

hi  Normal                                  ctermfg=12  ctermbg=8  guifg=#839496  guibg=#14161a gui=NONE

set background=dark

hi  ColorColumn                             cterm=NONE  ctermbg=0  guibg=#282c34 gui=NONE
...
hi  CursorLine                              cterm=NONE  ctermbg=0  guibg=#292926  guisp=#93a1a1  gui=NONE
...
hi  LineNr                                  cterm=NONE  ctermfg=10  ctermbg=0  guifg=#798B90  guibg=#202329 gui=NONE " old guifg: #586e75
...
hi  TabLine                                 cterm=underline  ctermfg=12  ctermbg=0  guifg=#839496  guibg=#282827  guisp=#839496  gui=underline
hi  TabLineFill                             cterm=underline  ctermfg=12  ctermbg=0  guifg=#839496  guibg=#181a1f  guisp=#839496  gui=underline
hi  TabLineSel                              cterm=underline,reverse  ctermfg=10  ctermbg=7  guifg=#aa9deb  guibg=#073642 guisp=#839496  gui=underline,reverse
